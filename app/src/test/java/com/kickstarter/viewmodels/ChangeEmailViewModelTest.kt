...
class ChangeEmailViewModelTest : KSRobolectricTestCase() {
    ...
    fun testCurrentEmail() {
        ...
        this.koalaTest.assertValue("Viewed_Change_Email")
    }
    ...
    fun testSendVerificationEmail() {
        ...
        this.koalaTest.assertValues("Viewed_Change_Email", "Resent_Verification_Email")
    }
    ...
    fun testSuccess() {
        ...
        this.success.assertValueCount(1)
        this.koalaTest.assertValues("Viewed_Change_Email", "Changed_Email")
    }
